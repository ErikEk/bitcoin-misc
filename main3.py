...
def main():
    ...
    # we sign with the private key corresponding to the script - no key tweaking required
    sig = privkey_tr_script_B.sign_taproot_input(tx, 0, utxos_scriptPubkeys,
                                                 amounts, script_path=True,
    ...
    tx.witnesses.append( TxWitnessInput([ sig, tr_script_p2pk_B.to_hex(), control_block.to_hex() ]) )
